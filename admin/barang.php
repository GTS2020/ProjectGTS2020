    ...
    <table class="table">
      ...
      <tbody>
        ...
        ?>
          <tr>
            <td><?= $no++; ?></td>
            <td><img src="../gambar/<?= $data['gambar']; ?>" width="150px" height="150px"></td>
            <td><?= $data['nama_barang']; ?></td>
            <td><?= $data['deskripsi']; ?></td>
            <td><?= $data['qty']; ?></td>
            <td><?= $data['harga_barang']; ?></td>
            <td><a href='editbarang.php?barang=<?= $data['nama_barang']; ?>'><i class='fas fa-edit' style='color: green;'></i>
              </a>&nbsp<a href='hapus.php?barang=<?= $data['nama_barang']; ?>'><i class='far fa-times-circle' style='color: red;'></i>
              </a></td>
          </tr>
